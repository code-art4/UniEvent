...
const event = () => {
	...
	return (
		<div>
			...
			{openEventPreview ? <div className='fixed top-[50%] left-[50%] w-[90%] md:w-[60%] mx-auto bg-white shadow-[#FFD95A] z-[50] px-10 py-7 h-[95vh] md:h-[80vh] overflow-auto' style={{ transform: 'translate(-50%, -50%)' }}>
