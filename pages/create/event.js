...
const CreateEvent = () => {
	...
	return (
		<div>
			...
			{openEventPreview ? <div className='fixed top-[50%] left-[50%] w-[95%] md:w-[60%] mx-auto bg-white shadow-[#FFD95A] z-[50] px-10 py-7 h-[80vh] overflow-auto' style={{ transform: 'translate(-50%, -50%)' }}>
