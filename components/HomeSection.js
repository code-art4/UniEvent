...
const HomeSection = ({ events }) => {
	if (events.length < 1) {
		return <div className='w-full bg-black/[2%] md:px-[20px] px-[10px] mt-10 py-10 flex justify-center flex-col items-center'><p className='text-white'>No current events</p></div>
	}
